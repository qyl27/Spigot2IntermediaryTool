...
{
    public class Intermediary2SpigotSrg
    {
        ...
        public Intermediary2SpigotSrg(string[] bukkitClasses, string[] bukkitMembers, string[] intermediaryMerged)
        {
        ...
        private void MakeSrg()
        {
            ...
            foreach (var intermediaryLine in IntermediaryMerged)
            {
                if (intermediaryLine.StartsWith("CLASS"))
                {
                    ...
                    var result = $"CL: {classLine[2]} {MojangToBukkitClasses[classLine[1]]}";
